...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.keli.hfbus", "alarm", ALARMS);
        sURLMatcher.addURI("com.keli.hfbus", "alarm/#", ALARMS_ID);
    }
...
//                    "(hour1, minutes1,hour2, minutes2,hour3, minutes3,hour4, minutes4 daysofweek, alarmtime1,alarmtime2,,alarmtime3,alarmtime4, enabled, vibrate, message, alert,) " +
//                    "VALUES ";
